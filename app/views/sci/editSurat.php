        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <h4>Edit Surat Sentral Citra Indonesia</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control" name="tanggal" value="<?= $surat['tgl_surat']; ?>">
                            </div>
                        </div>
                        <div class="col-1">
                            <a href="<?= BASEURL . '/' . $data['perusahaan'] . '/hapusSurat/' . $surat['id']; ?>">
                    ...
                    <div class="row mt-4">
                            ...
                            <table class="table table-hover table-bordered table-sm text-center">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data['barang'] as $barang) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td class="text-left"><span class="ml-2"><?= $barang['nama_barang']; ?></span></td>
                                            <td><?= $barang['ket']; ?></td>
                                            <td><?= $barang['qty']; ?></td>
                        ...
                        <div class="col-5">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">1. Harga Termasuk PPN <?= $surat['ppn']; ?>%
                                    <input type="hidden" name="ppn" value="<?= $surat['ppn']; ?>">
                                </li>
                                <li class="list-group-item">2. Pembayaran Sesuai
                                    ...
                                    <input class="ml-1" id="tempo" name="tempo" size="2" placeholder="..Hari" value="<?= $surat['tempo']; ?>">
                                    <br>
                                ...
                                <li class="list-group-item">3. Pembayaran untuk transaksi ini mohon di transfer ke Rekening : <br>
                                    ...
                                    <!-- <input type="hidden" name="rekening" value="PT. Sentral Citra Indonesia-5222227071"> -->
                                </li>
...
<input id="rek" type="hidden" name="rek" value="<?= $surat['rekening']; ?>">