...
<body>
    <div class="margin">
        <div class="kop">
            <img src="<?= PUBLICC; ?>/img/cii/CII_Kop.png">
        </div>
        <div class="main">
            <div class="detail">
                ...
                <div class="header-surat">
                    ...
                    <table cellspacing="0" class="detail-table">
                        ...
                        foreach ($data['interior'] as $interior) : ?>
                            ...
                            <tr>
                                <td class="border-left-0"><?= $no++; ?></td>
                                <td><?= strtoupper($interior['nama_interior']); ?></td>
                                <td><?= $interior['volume1'] . 'm X ' . $interior['volume2'] . 'm'; ?></td>
                                <td>
                                    <span class="float-left ml-3">Rp.</span>
                                    <span class="float-right mr-2"><?= format_ribuan($interior['harga']); ?></span>
                                </td>
                                <td class="border-right-0">
                                    <span class="float-left ml-3">Rp.</span>
                                    <span class="float-right mr-2"><?= format_ribuan($interior['volume1'] * $interior['volume2'] * $interior['harga']); ?></span>
                                </td>
                            </tr>
                            <?php $jumlah += $interior['volume1'] * $interior['volume2'] * $interior['harga']; ?>
                        <?php endforeach; ?>
                    ...
                    <div class="row mt-0">
                        ...
                        <div class="col-6 text-center">
                            ...
                            <img src="<?= PUBLICC; ?>/img/cii/CII_Logo.png" style="width: 28%; margin-top: 2%; opacity: 0.95;"> <br>
