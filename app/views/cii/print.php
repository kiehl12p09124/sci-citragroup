        ...
        <div class="main">
                ...
                <table class="mt-lg-5" cellspacing="0" cellpadding="2" align="center">
                    ...
                    <tbody>
                        ...
                        foreach ($data['interior'] as $interior) : ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td class="text-left"><?= strtoupper($interior['nama_interior']); ?></td>
                                <td><?= $interior['volume1'] . 'm X ' . $interior['volume2'] . 'm'; ?></td>
                                <td>
                                    <span class="float-left ml-3">Rp.</span>
                                    <span class="float-right"><?= format_ribuan($interior['harga']); ?></span>
                                </td>
                                <td>
                                    <span class="float-left ml-3">Rp.</span>
                        ...
                        <tr>
                            ...
                            <td><span class="float-left ml-3">Rp.</span>
            ...
            <div class="cap-surat-main mt-5">
                <div class="cap-surat">
                    ...
                    <img class="jarak" align="center" src="<?= PUBLICC; ?>/img/CII/CII_Logo.png" style="width: 70%; margin-left: 18%; margin-bottom: -8%;"><br>
