        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <h4>Tambah Surat Citra Furniture Indonesia</h4>
                </div>
            </div>
            <div class="card-body">
                <form action="<?= BASEURL;?>/CF/tambahSurat" method="post">
                <!-- Tambah Data Surat -->
                    <div class="row">
                        <div class="col-3">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="no_seri" value="CF/<?= romawi(date('m')).'/'.date('Y').'/'.str_pad($data['available_seri'], 3,'0', STR_PAD_LEFT);?>" readonly>
                            </div>
                        </div>                     
                    </div>
