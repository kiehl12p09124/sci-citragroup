        ...
        <div class="main">
                ...
                <table class="mt-lg-5" cellspacing="0" cellpadding="2" align="center">
                    ...
                    <tbody>
                        ...
                        foreach ($data['barang'] as $barang) : ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td class="text-left"><?= strtoupper($barang['nama_barang']); ?></td>
                                <td><?= $barang['ket']; ?></td>
                                <td><?= $barang['qty']; ?></td>
                                <td>
            ...
            <div class="cap-surat-main mt-5">
                <div class="cap-surat">
                    ...
                    <img class="jarak" align="center" src="<?= PUBLICC; ?>/img/cf/cf_Logo.png" style="width: 70%; margin-left: 18%; margin-bottom: -8%;"><br>
